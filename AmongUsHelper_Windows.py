...
canvas1 = tk.Canvas(root, width = 115, height = 360,  relief = 'raised',bg='#141414')
canvas1.pack()
target='null'
temp=''
...
canvas1.create_window(40, 345, window=backB)
infoB.lower()
backB.lower()

resetB = tk.Button(text='RESET', bg='#FF0000', command=clearInfo, width=a)
canvas1.create_window(40, 345, window=resetB)
